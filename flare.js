...
var canvas = document.querySelector(".sun-canvas");
...
var config = {
  ...
  CURL: 0,
  SPLAT_RADIUS: 0.05, // 0.5
  SPLAT_FORCE: 1000, // 6000
  SHADING: false,
  COLORFUL: false,
...
function multipleSplats(amount) {
  for (var i = 0; i < amount; i++) {
    ...
    color.b *= 10.0;
    // var color = {
    //   r: 1.0, // These values will be multiplied by the splat intensity
    //   g: 0.867, // in the original code (they all get multiplied by 10)
    //   b: 0.008, // so they're set to directly match your desired color
    // };
    var x = Math.random();
    var y = Math.random();
...
sunEl.addEventListener("mouseenter", function (e) {
...
sunEl.addEventListener("mousemove", function (e) {
